// Harvests crates/clark-core/tests/fixtures/wrap.json from the real fast-wrap-ansi.
//
// The Rust port in crates/clark-core/src/wrap.rs is checked against the fixture, never against a live
...
const FIXTURE = new URL('../crates/clark-core/tests/fixtures/wrap.json', HERE);
