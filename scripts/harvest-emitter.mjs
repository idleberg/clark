// Harvests crates/clark-core/tests/fixtures/emitter.json from `@clack/core`'s own Prompt.render.
//
...
const FIXTURE = new URL('../crates/clark-core/tests/fixtures/emitter.json', HERE);
