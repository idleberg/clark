...
use clackatui_core::date::{Date as CivilDate, DateFormat, DateState, DateWidget, validator};
use clackatui_core::prompt::{Outcome, Prompt, Validator};
use clackatui_core::session::Session;
use clackatui_core::settings::{DateMessages, Settings};
...
///
/// ```no_run
/// use clackatui::DateFormat;
///
/// let birthday = clackatui::date("Pick your birthday")
