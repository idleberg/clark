...
///
/// ```no_run
/// let framework = clackatui::autocomplete("Search for a framework")
///     .option("next")
///     .option("astro")
...
impl<T> Autocomplete<T> {
	...
	/// [`default_filter`](clackatui_core::autocomplete::default_filter).
...
///
/// ```no_run
/// let frameworks = clackatui::autocomplete_multiselect("Select frameworks")
///     .option("next")
///     .option("astro")
///     .required(true)
///     .interact()?;
...
/// [`default_filter`](clackatui_core::autocomplete::default_filter) for a value that cannot print
